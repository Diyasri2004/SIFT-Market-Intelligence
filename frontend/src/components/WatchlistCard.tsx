...
const Sparkline: React.FC<{ positive: boolean; seed: number }> = ({ positive, seed }) => {
  ...
  return <svg className="card-sparkline" viewBox="0 0 100 40" preserveAspectRatio="none" aria-hidden="true"><polyline points={points} fill="none" stroke={color} strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" /><polyline points={`0,40 ${points} 100,40`} fill={positive ? 'url(#sparkGreen)' : 'url(#sparkRed)'} stroke="none" opacity=".22" /><defs><linearGradient id="sparkGreen" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#b9ed65"/><stop offset="1" stopColor="#b9ed65" stopOpacity="0"/></linearGradient><linearGradient id="sparkRed" x1="0" y1="0" x2="0" y2="1"><stop stopColor="#ff7b78"/><stop offset="1" stopColor="#ff7b78" stopOpacity="0"/></linearGradient></defs></svg>;
};
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onMouseEnter={(e) => {
          (e.currentTarget as HTMLElement).style.color = 'var(--bear-red)';
